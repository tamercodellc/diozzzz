...
export function ShimmerButton({
  ...
  const variantStyles = {
    primary:
        'bg-gradient-to-br from-secondary border to-primary hover:-translate-y-[2px] hover:shadow-ring/20 hover:bg-ring text-white hover:shadow-xl',
    secondary:
        'bg-secondary/80 text-white backdrop-blur-sm border border-ring hover:bg-primary hover:border-ring hover:shadow-black/20 hover:shadow-xl',
    outline:
    ...
    solid:
        'bg-primary text-white hover:bg-secondary hover:-translate-y-[2px] hover:shadow-ring/20 hover:bg-ring hover:text-white hover:shadow-xl',
    solidGreen:
  ...
  // Altura fija para botones tipo submit
  const submitButtonHeight = type === 'submit' ? 'h-10' : '';
