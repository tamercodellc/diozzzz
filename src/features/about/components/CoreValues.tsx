        ...
        <div className='relative overflow-hidden '>
            ...
            <div className='max-w-7xl mx-auto px-4 relative z-10'>
                <div className='text-center mb-16'>
                    ...
                    >
                        Built on
                        <span className='heading-gradient'> Strong</span> Values
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                    ...
                    {[0, 1, 2, 3].map((index) => (
                        ...
                        >
                            <div
                                className='relative overflow-hidden rounded-2xl  border border-ring/10 p-8 h-full transition-all duration-300 hover:translate-y-[-4px] flex gap-8'>
                                        ...
                                        <div className='relative w-full h-full'>
                                            <div className='absolute inset-0 flex items-center justify-center'>
                                                <div className='relative w-[250px] h-[250px]'>
                                                    ...
                                                    {/* Center icon */}
                                                    <div
                                                        className='absolute inset-[40%] bg-card border border-ring/50 rounded-full flex items-center justify-center'>
                                                    ...
                                                    >
                                                        <div
                                                            ...
                                                            <div
                                                                className='w-10 h-10 bg-card border border-ring/50 rounded-xl flex items-center justify-center'>
                                ...
                                <div
                                    className='absolute inset-0 border border-primary/0 rounded-2xl transition-all duration-300 group-hover:border-primary/50'/>
                            </div>
                        </motion.div>
                    ))}
                    ...
                    >
                        <div className='relative overflow-hidden rounded-2xl  p-8 h-full transition-all duration-300'>
                          ...
                          rounded-xl bg-card border border-ring/50 flex items-center justify-center'
                                            ...
                                            {/* Center Arrows */}
                                            <div
                                                className='absolute inset-[40%] rounded-xl bg-gradient-to-r from-primary to-secondary flex items-center justify-center'>
