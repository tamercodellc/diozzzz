  ...
  return (
      <div ref={containerRef} className='relative overflow-hidden'>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-18 container flex items-center justify-center gap-4 flex-col'>
          {/* Only replacing this Leading Section with the custom markup */}
          <div className="text-center mb-16 max-w-3xl">
            <div className="flex justify-center mb-4">
              <IconButton3D icon={ZapIcon} variant="blue" />
            </div>
            ...
            >
              You're About to Become an <br/>
              <span className='heading-gradient'>Authority in Your Industry</span>
            </motion.h2>
            ...
            >
              Soon, your business will be the reference in your industry. You won't just climb rankings - you'll attract more customers, increase visibility, and dominate your local market with a strategy designed for success.
            </motion.p>
          </div>
