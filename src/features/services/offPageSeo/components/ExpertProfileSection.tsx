            ...
            <div className='space-y-8 flex flex-col items-center'>
              ...
              <div className="text-center mb-16">
                ...
                <h2 className='text-2xl font-bold tracking-tight text-foreground sm:text-3xl mb-6'>
                  Transform Your <br/>
                  <span className='heading-gradient'>Digital Presence</span>
                </h2>

                <p className="text-foreground/80 max-w-2xl mx-auto text-center">
                  We help small business owners improve their online visibility and authority by building natural, high-quality link profiles. Drawing from personal experience.
                </p>
              </div>
