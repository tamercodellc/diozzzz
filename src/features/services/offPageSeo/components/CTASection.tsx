        ...
        <div className='relative max-w-4xl mx-auto px-4 text-center'>
          ...
          <div className="text-center mb-16">
            <div className="flex justify-center mb-4">
              <IconButton3D icon={Gift} variant="blue" />
            </div>
            ...
            >
              ...
              <span className='heading-gradient'>True Potential</span>
            </motion.h2>
            ...
            >
              Get a comprehensive analysis of your website's SEO performance and discover untapped opportunities for growth. Enter your details below to receive your free audit report.
            </motion.p>
          </div>
