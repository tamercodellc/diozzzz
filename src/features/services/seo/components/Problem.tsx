        ...
        <div className='relative w-full overflow-hidden'>
            <div className='container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative'>
                ...
                <div className='relative h-[550px] mb-8'>
                    {/* Left Card */}
                    <div
                        className='absolute top-[80px] left-[60px] w-[380px] h-[450px] rounded-xl shadow-2xl overflow-hidden transform -rotate-12 perspective-[1000px] rotate-x-[20deg] z-10 [box-shadow:inset_0_2px_20px_rgba(0,0,0,0.2)]'>
                        <div className='p-4 bg-gray-300 text-neutral-800'>
                            <div className='flex items-center gap-2 mb-4'>
                                <div
                                    className='w-6 h-6 text-foreground bg-card flex items-center justify-center rounded font-bold'>
                                    T
                                </div>
                    ...
                    {/* Center Card */}
                    <div
                        className='absolute top-[20px] left-1/2 -translate-x-1/2 w-[380px] h-[450px] bg-gradient-to-br from-red-900 to-red-600 rounded-xl shadow-2xl overflow-hidden z-30'>
                        <div className='p-4 text-white'>
                            <div className='flex items-center gap-2 mb-4'>
                                <div
                                    className='w-6 h-6 bg-card text-red-600 flex items-center justify-center rounded font-bold'>
                                    C
                                </div>
                    ...
                    {/* Right Card */}
                    <div
                        className='absolute top-[80px] right-[60px] w-[380px] h-[450px] bg-gray-300 rounded-xl shadow-2xl overflow-hidden transform rotate-12 perspective-[1000px] rotate-x-[20deg] z-20'>
                        <div className='p-4 text-foreground'>
                            <div className='flex items-center gap-2 mb-4'>
                                <div
                                    className='w-6 h-6 bg-card text-foreground flex items-center justify-center rounded font-bold'>
                                    R
                                </div>
                ...
                <div
                    className='relative -mt-64 mx-auto p-16 bg-card/80 backdrop-blur-3xl rounded-2xl shadow-lg border-2 border-ring/5  z-40 text-center'>
                    <div className="mb-8 flex flex-col items-center">
                        <div className="mb-4">
                            <IconButton3D icon={Inspect} variant="red"/>
                        </div>
                        <motion.h2
                        ...
                        >
                            Your Website's Technical Foundation Is Crumbling <br/>
                            <span className='heading-gradient-red-bright'> (And It's Costing You Money)</span>
                        </motion.h2>
                        <motion.p
                        ...
                        >
                            Do you recognize any of these symptoms? They're clear signs that your website's technical
                            foundation needs urgent professional attention. Most businesses don't realize how much
                            revenue they're losing due to these hidden issues.
                        </motion.p>
                    </div>
