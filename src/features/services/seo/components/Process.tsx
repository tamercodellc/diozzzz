      ...
      <div className='relative w-full overflow-hidden'>
        <div className='max-w-7xl mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            >
              Transform Your Technical SEO in
              <span className='heading-gradient'> 90 Days</span>
            </motion.h2>
            ...
            >
              A systematic approach to turn technical challenges into explosive
