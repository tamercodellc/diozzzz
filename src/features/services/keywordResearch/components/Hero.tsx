    ...
    <div className='w-full pt-36 relative overflow-hidden'>
      <div className='relative  flex flex-col items-center justify-center overflow-hidden '>
        <div className='relative flex flex-col items-center justify-center gap-8 md:gap-12'>
          ...
          <p className='relative z-10 mx-auto mt-2 max-w-2xl text-center text-sm md:text-lg text-gray-700 dark:text-white backdrop-filter backdrop-blur-md p-1 rounded-lg text-pretty'>
