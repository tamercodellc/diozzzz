        ...
        <div className='relative w-[75vw] max-w-[1600px] h-[500px] mx-auto mt-16 flex items-center justify-center'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <h4 className='text-foreground font-medium'>
                      Impulsa tu Negocio: El Poder del Keyword Research
                    </h4>
                    <p className='text-foreground/80 text-sm'>
                      Descubre cómo las palabras clave transforman empresas completas
                    </p>
                  </div>
                </div>
                <span className='text-foreground/80 text-sm'>
                Guía estratégica de 12 minutos
              </span>
              </div>
            </div>
          </div>
          ...
          <div className='absolute top-4 right-6 z-3'>
            <p className='text-primary font-medium flex items-center gap-2'>
              ...
              Ver masterclass gratuita ahora
            </p>
          </div>
        </div>
      </div>
