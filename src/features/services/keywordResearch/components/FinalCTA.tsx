              ...
              <div className='relative w-full pb-14 overflow-hidden'>
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative'>
                  <div className='text-center mb-12'>
                    ...
                    >
                      Schedule your free strategy session now and discover how our proven keyword research process can help you attract more qualified leads and grow your business.
                    </motion.p>
                  </div>
