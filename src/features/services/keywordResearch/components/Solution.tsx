      ...
      <div className='relative w-full py-16 md:py-24 overflow-hidden'>
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6'>
          ...
          <div className="text-center mb-16">
            ...
            >
              An SEO approach that
              <span className='heading-gradient'> actually works</span>
            </motion.h2>
            ...
            >
              I guide you to transform your online visibility with strategies that go beyond simple keywords.
            </motion.p>
          </div>
