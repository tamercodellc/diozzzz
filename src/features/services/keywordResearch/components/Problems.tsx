              ...
              <div className='max-w-7xl mx-auto px-4 py-12'>
                ...
                <div className="text-center mb-16">
                  <div className="flex justify-center mb-4">
                    <IconButton3D icon={AlertTriangle} variant="red" />
                  </div>
                  ...
                  >
                    Is Your Business Losing Money Due to <br/>
                    <span className='heading-gradient-red-bright'>Poor Keyword Strategy?</span>
                  </motion.h2>
                  ...
                  >
                    Many businesses are unknowingly sabotaging their growth with ineffective keyword research.
                    ...
                    {[
                      ...
                      },
                      {
                        ...
                        <motion.div
                            ...
                            className='flex items-center justify-center gap-2 bg-card rounded-lg p-4 min-w-72 border border-ring/5 hover:border-red-500 transition-all duration-700 ease-in-out'
                        >
                                ...
                                <div className='space-y-2'>
                                  {card.data.map((item) => (
                                      ...
                                      >
                                        ...
                                        <span className='text-sm text-red-500 w-12 text-right font-medium'>
                                  {item.value}
                                </span>
                                      </div>
                                  ))}
