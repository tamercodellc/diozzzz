      ...
      <div className='relative w-full overflow-hidden bg-gradient-to-b from-transparent to-primary/5 pb-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative'>
          ...
          <div className='text-center mb-16 relative z-10'>
            ...
            >
              What Our Customers
              <span className='heading-gradient'> Say</span>
            </motion.h2>
            ...
            >
              Discover how our keyword research service has helped businesses like yours achieve remarkable growth and success in their digital presence.
            </motion.p>
          </div>
