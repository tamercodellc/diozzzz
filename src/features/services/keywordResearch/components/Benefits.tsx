          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='space-y-8'>
              <div className="mb-8">
                ...
                >
                  Transform Your
                  <span className='heading-gradient'> Search Visibility</span>
                </motion.h2>
                ...
                <motion.p
                    ...
                    className="text-foreground/80 lg:text-left"
                >
                  Our keyword research service combines advanced analytics with strategic insights to help you capture more qualified traffic and convert it into real business growth.
                </motion.p>
              </div>
