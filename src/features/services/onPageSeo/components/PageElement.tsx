      ...
      <div className="relative">
        ...
        <div className="w-full max-w-4xl mx-auto">
          <div className="text-center mb-8 space-y-4">
            ...
            >
              Multiply Your Online Visibility and Attract
              <span className='heading-gradient'> Customers Who are Actively Searching for your Services</span>
            </motion.h1>
            ...
            <motion.p
                ...
                className="text-foreground/80 max-w-2xl mx-auto text-center pb-6"
            >
