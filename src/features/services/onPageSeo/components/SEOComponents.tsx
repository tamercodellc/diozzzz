  ...
  return (
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        <div className="flex items-center mb-4">
          <div className="mr-3 p-2 rounded-lg bg-ring/10 text-red-500">
            <Zap size={20} />
          </div>
        ...
        <div className="bg-ring/10 p-4 rounded-md">
          <div className="flex items-center mb-3">
            <FastForward size={16} className="text-red-500 mr-2" />
            <span className="text-xs font-medium text-foreground/80">
            Load time
          </span>
            <span className="ml-auto text-xs font-bold text-red-500">8.5s</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            <div>
              ...
              <div className="p-1.5 rounded bg-red-500/10 text-red-500 text-xs">
                5.2s
              </div>
            </div>
            <div>
  ...
  return (
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="bg-ring/10 p-4 rounded-md border border-foreground text-xs font-mono overflow-hidden mb-4">
          <div className="text-red-500">Invalid Schema Markup</div>
  ...
  return (
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="flex flex-col items-center p-3 bg-ring/10 rounded-md">
            <Tablet size={24} className="text-red-500 mb-2" />
          ...
          <div className="flex flex-col items-center p-3 bg-ring/10 rounded-md">
            <Monitor size={24} className="text-red-500 mb-2" />
  ...
  return (
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <span className="text-xs font-medium text-foreground/80">
                ...
                <span className="text-xs text-red-500 font-medium">5.2s</span>
              </div>
            ...
            <div>
              ...
              <span className="text-xs font-medium text-foreground/80">
                ...
                <span className="text-xs text-red-500 font-medium">350ms</span>
              </div>
              <div className="w-full h-1.5 bg-foreground rounded-full">
                <div
                    className="h-full bg-red-500 rounded-full"
            ...
            <div>
              ...
              <span className="text-xs font-medium text-foreground/80">
                ...
                <span className="text-xs text-red-500 font-medium">0.45</span>
              </div>
              <div className="w-full h-1.5 bg-foreground rounded-full">
                <div
                    className="h-full bg-red-500 rounded-full"
        ...
        <div className="flex items-center text-xs text-foreground/80">
          <div className="w-5 h-5 rounded-lg bg-ring/10 text-red-500 flex items-center justify-center mr-2">
            <XCircle size={12} />
          </div>
      ...
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="flex mb-4">
          <div className="flex-1 text-center p-3 bg-ring/10 rounded-md mr-3">
            ...
            <div className="text-xl font-bold text-red-500">0:24</div>
          ...
          <div className="flex-1 text-center p-3 bg-ring/10 rounded-md">
            ...
            <div className="text-[10px] text-red-500 font-medium">▲ 32%</div>
          </div>
        </div>

        <ul className="text-xs text-foreground/80 space-y-2">
          <li className="flex items-start">
            <div className="w-5 h-5 mt-0 mr-2 rounded-lg bg-ring/10 text-red-500 flex items-center justify-center">
              <XCircle size={12} />
            </div>
      ...
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="relative bg-ring/10 rounded-md p-4 mb-4 flex justify-center">
          <div className="flex flex-col items-center opacity-50">
            <div className="w-32 h-10 rounded-md bg-red-500  flex items-center justify-center text-xs mb-2">
              Main Topic
            </div>
            <div className="h-6 border-l border-red-500"></div>
            <div className="flex space-x-8">
              <div className="flex flex-col items-center">
                <div className="w-24 h-8 rounded-md bg-red-500/50  flex items-center justify-center text-xs mb-2">
                  Missing
                </div>
                <div className="h-4 border-l border-red-500"></div>
                <div className="flex space-x-2">
                  <div className="w-16 h-6 rounded-md bg-red-500/30 text-red-500 flex items-center justify-center text-[10px]">
                    Error
                  </div>
                  <div className="w-16 h-6 rounded-md bg-red-500/30 text-red-500 flex items-center justify-center text-[10px]">
                    404
      ...
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="bg-ring/10 p-4 rounded-md mb-4">
          ...
          <span className="text-xs font-medium text-foreground/80">
            ...
            <div className="px-2 py-1 rounded-full bg-red-500/10 text-red-500 text-[10px] font-medium">
              Poor
            </div>
          </div>
      ...
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="bg-ring/10 p-4 rounded-md mb-4">
          ...
          <span className="text-xs font-medium text-foreground/80">
            ...
            <div className="px-2 py-1 rounded-full bg-red-500/10 text-red-500 text-[10px]">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              <div className="bg-red-500/10 px-2 py-1 rounded text-[10px] text-red-500 mr-2">
                Main
              </div>
              <div className="text-[10px] text-foreground/80 flex-1 truncate">
                seo positioning
              </div>
              <div className="ml-2 text-[10px] font-medium text-red-500">1x</div>
            </div>
            <div className="flex items-center">
              <div className="bg-red-500/5 px-2 py-1 rounded text-[10px] text-red-500 mr-2">
                LSI
              </div>
              <div className="text-[10px] text-foreground/80 flex-1 truncate">
                web optimization
              </div>
              <div className="ml-2 text-[10px] font-medium text-red-500">0x</div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
      <div className="w-full rounded-lg border border-foreground/20 bg-card/95 p-4 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="flex items-center">
          ...
          <span className="text-xs font-medium text-red-500">22%</span>
        </div>
      </div>
  );
};
        ...
        <div className="bg-ring/10 p-4 rounded-md mb-4">
          <div className="space-y-4">
            <div className="flex items-start">
              <div className="w-6 h-6 rounded-lg bg-ring/10 text-red-500 flex items-center justify-center text-[10px] mt-0 mr-2 flex-shrink-0">
