        ...
        <section className='relative py-16 overflow-hidden'>
            <div className='w-full grid grid-cols-1 md:grid-cols-3 my-20 md:my-40 justify-start relative z-20 max-w-7xl mx-auto'>
                ...
                <motion.div
                    ...
                    className='md:col-span-2 p-8 md:p-14'
                >
                    <motion.h2
                        ...
                        className='text-left text-2xl md:text-3xl font-bold tracking-tight text-foreground mb-6'
                    >
                        Transform your content into <br/>
                        <span className='heading-gradient'>business results</span>
                    </motion.h2>
                    ...
                    <motion.p
                        ...
                        className='text-left text-foreground/80 mt-4 max-w-lg text-xl tracking-tight mb-8'
                    >
                    ...
                    <motion.div
                        ...
                        className='flex items-start sm:items-center flex-col sm:flex-row sm:gap-4 py-6'
                    >
                ...
                <motion.div
                    ...
                    className='border-t md:border-t-0 md:border-l border-dashed border-foreground/20 p-8 md:p-14'
                >
