  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-20">
        <section className="flex items-center justify-center bg-transparent -mb-32 -mt-14">
        ...
        <p className="trelative z-10 mx-auto mt-2 max-w-2xl text-center text-sm md:text-lg text-gray-700 dark:text-white backdrop-filter backdrop-blur-md p-1 rounded-lg mb-6 text-pretty">
