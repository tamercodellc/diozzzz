...
export function ContactFormGridWithDetails() {
  return (
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:px-6 md:py-20 lg:grid-cols-2">
      ...
      <div className="relative mx-auto flex w-full max-w-2xl flex-col items-start gap-4 overflow-hidden rounded-lg border border-card p-4 sm:p-10 bg-gradient-to-l from-card via-card/90 to-card/20">
        <Grid />
        <form
  ...
  return (
    ...
    >
      <div className="h-full w-full">
        ...
        >
          <>
            <div className="absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-primary/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"></div>
            <div className="absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-primary/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"></div>
            <div className="absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-primary/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"></div>
          </>
        </div>
        ...
        <>
          <div className="absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-primary blur-[2px]" />
          <div className="absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-primary" />
          <div className="absolute bottom-1/2 right-1/2 z-40 h-[4px] w-[4px] translate-x-[1.5px] translate-y-[14px] rounded-full bg-primary blur-[3px]" />
          <div className="absolute bottom-1/2 right-1/2 z-40 h-[2px] w-[2px] translate-x-[0.5px] translate-y-[14px] rounded-full bg-primary" />
        </>
      </div>
    </div>
  );
