import {BorderBeam, Grid, HeroButtonsSet} from '@/components/ui';
        ...
        <div className='relative overflow-hidden rounded-lg border'>
          ...
          <div className='relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 p-8 md:p-12'>
            ...
            <div className='flex text-center justify-center flex-col p-4 relative z-40'>
              <h2 className='text-2xl font-bold tracking-tight text-foreground sm:text-3xl md:text-center text-center pb-4 pt-4'>
                Want to Learn
                <span className='heading-gradient'> More?</span>
              </h2>
              <p className='text-foreground/80 max-w-xl mb-12'>
