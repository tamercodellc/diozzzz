...
export const seoServices: Service[] = [
  ...
  {
    title: 'Link Building',
    description: 'Quality backlinks & outreach',
    icon: Link,
    features: ['Prospect research', 'Outreach campaigns', 'Guest posting'],
...
export const marketingServices: Service[] = [
  {
    title: 'Google Ads',
    description: 'Sales-driven paid campaigns',
    icon: Target,
  ...
  },
  {
    ...
    icon: Share2,
    features: ['Content strategy', 'Community management', 'Engagement growth'],
  ...
  },
  {
    ...
    description: 'Paid promotions on social platforms',
    icon: DollarSign,
    features: ['Audience targeting', 'A/B testing', 'Performance tracking'],
    cta: 'Explore Social Media Ads',
  },
  {
    title: 'Sales Funnel',
    description: 'Convert visitors into customers',
    icon: LineChart,
    features: ['Lead generation', 'Nurture sequences', 'Conversion optimization'],
  ...
  },
  {
    ...
    icon: CodeIcon,
    features: ['Custom themes', 'Responsive layouts', 'UX/UI optimization'],
  ...
  },
  {
    ...
    icon: Users,
    features: ['Strategy development', 'Performance auditing', 'Training & support'],
