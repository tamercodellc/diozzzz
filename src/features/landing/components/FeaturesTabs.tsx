      ...
      <div className="w-full font-sans md:px-10" ref={containerRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
          ...
          >
            ...
            <br />
            It&apos;s What
            <span className='heading-gradient'> Our Clients Achieve</span> every day
          </motion.h2>
          <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-foreground/80 max-w-2xl mx-auto mb-8 text-center"
          >
        ...
        <div ref={ref} className="relative max-w-7xl mx-auto pb-20 hidden md:block">
          {timelineData.map((item, index) => (
              <div
                  key={index}
                  className={`flex justify-start pt-40 gap-10 pl-16 ${
                      item.title === 'Sales & Conversion Growth' ? 'pb-32' : ''
                  }`}
              >
                <div className="relative w-full">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Card Component */}
                    <div className="space-y-4 mx-auto w-full pt-12 md:pt-0">
                      <h3 className="text-primary text-2xl font-bold text-center">
                        {item.title}
                      </h3>
                      <div className="h-[300px] w-full">{item.content}</div>
                    </div>
        ...
        {/* Mobile View */}
        <div className="md:hidden max-w-7xl mx-auto space-y-16 px-4 sm:px-6 lg:px-8 pb-20">
          {timelineData.map((item, index) => (
              <div key={index} className="w-full flex flex-col items-center">
                <div className="w-full max-w-md">
                  ...
                  <div className="h-[300px] w-full mb-6">{item.content}</div>
