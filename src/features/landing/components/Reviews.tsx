      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <motion.h2
              ...
              className="mb-4 md:mb-6 text-center text-2xl sm:text-3xl font-bold tracking-tight text-foreground"
          >
            Trusted by Growing <span className='heading-gradient'> Businesses</span>
          </motion.h2>
          <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-foreground/80 text-center max-w-2xl mx-auto"
          >
