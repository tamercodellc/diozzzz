...
import { Mic, Camera, Circle } from 'lucide-react';
...
export function GoogleCard() {
  ...
  return (
    <div className="w-full relative overflow-hidden backdrop-blur-sm group transition-all duration-300">
          ...
          <div className="mx-auto max-w-[300px] w-full">
            <div className="flex items-center bg-ring/40 rounded-lg px-4 py-2">
              ...
              <div className="flex items-center gap-3 shrink-0">
                {/* Google Blue Mic */}
                <Mic size={16} className="text-[#4285F4]" />
                {/* Google Yellow Camera */}
                <Camera size={16} className="text-[#FBBC05]" />
                {/* Google Search Icon (using SVG for multi-color) */}
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
