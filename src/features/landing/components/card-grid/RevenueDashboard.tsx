    ...
    () =>
        Promise.resolve(({ data }: { data: Data[] }) => (
            <BarChart
                ...
                style={{ background: 'transparent', maxWidth: '100%', overflow: 'hidden' }}
            >
                <XAxis
                    dataKey='month'
                    axisLine={false}
...
export const RevenueDashboard = () => {
    return (
        <div>
            <div
                className='p-4 rounded-lg h-48 flex gap-4 backdrop-blur-sm border border-ring/10'
                style={{
            ...
            <span className='text-foreground/80 text-sm font-light'>
              Revenue
                        ...
                        <span className='text-white text-xs px-2 py-1 rounded-lg backdrop-blur-sm'>
              Monthly
            </span>
                    </div>

                    <div className='relative'>
                        <div className='absolute left-[4.5rem] -top-2 w-10 h-6 rounded-lg z-10 backdrop-blur-sm flex items-center justify-center'>
